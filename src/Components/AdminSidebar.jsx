...
import logo from "../assets/ecoRecycle-Bu8FPTl-.svg";
import { ADMIN_DASHBOARD_SIDEBAR_UPPER_LINKS, ADMIN_DASHBOARD_SIDEBAR_BOTTOM_LINKS } from '../utils/AdminNavigation';
import { Link } from 'react-router-dom';
import { HiOutlineLogout } from 'react-icons/hi';

const linkClasses = 'flex item-center cursor-pointer gap-2 font-light px-3 py-3 hover:bg-neutral-500 hover:no-underline active:bg-neutral-600 rounded-sm text-base'
